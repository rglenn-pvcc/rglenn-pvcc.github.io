...
#   The data for each studend is appended to a list with six data fields:
...
def calculate_grades():
    ...
    for i in range(len(stu)):
        hw = int(stu[i][2]) # Last name is a pos. 0, first name is pos. 1, how homwork is pos. 2
        midex = int(stu[i][3]) # mideterm exam is in position 3
...
def create_report_file():
    ...
    repfile.write("\nReport Data/Time        : " + str(datetime.datetime.now()))
