...
def process_network_courses():
    global network_elect #this set mut be global since it is CHANGED in this fucntion
    ...
    for course in network_elect:
        asterisk_course = "*" + course #insert an asterisk in fron of ELECTIVE course name
        temp_set.add(asterisk_course)  #then add the new course name to a temporary set

    network_elect.clear() #remove all course from set of elective courses
...
def process_info_courses():
    ...
    global info_elect #this set mut be global since it is CHANGED in this fucntion
    ...
    info_elect.clear() #remove all course from set of elective courses
